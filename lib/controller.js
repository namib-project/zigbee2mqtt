...
const ExtensionWebOfThings = require('./extension/webofthings');
...
const AllExtensions = [
    ...
    ExtensionExternalConverters, ExtensionFrontend, ExtensionExternalExtension, ExtensionWebOfThings,
];
...
class Controller {
    constructor(restartCallback, exitCallback) {
        ...
        if (settings.get().webofthings) {
            this.extensions.push(new ExtensionWebOfThings(...args));
        }
